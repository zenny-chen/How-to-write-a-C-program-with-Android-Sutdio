...
不过本仓库中所附赠的demo是基于Android Studio 3.5版本完成的。大家可以在此处下载当前最新版的Android Studio：[https://developer.android.google.cn/studio/](https://developer.android.google.cn/studio/)。
